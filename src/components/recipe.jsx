...
export default function Recipe() {
  ...
  const handleCategoryChange = (cat) => {
    setCategory(cat);
    if (cat !== "All") fetchRecipesByCategory(cat);
  };
  ...
  const handleAreaChange = (selectedArea) => {
    ...
    setCategory("All"); 
    if (selectedArea !== "All") fetchRecipesByArea(selectedArea);
  };
    ...
    <div>
      ...
      <div className="hero">
        <div className="hero-content">
          ...
          <p>Discover meals from around the world! Search by name.</p>
          <div className="hero-search">
            ...
            />
            <button className="sbutton" onClick={() => fetchRecipes(search)}>
              Search
            </button>
            <button
